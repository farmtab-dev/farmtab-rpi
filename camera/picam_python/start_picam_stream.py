...
from h_cam_handler import getCamFilepath, getCamDupFilepath, changeCam, printDebug, captureImg, timeNow, get4X4ImgMerged, uploadAllToS3
...
def main():
    ...
    while True:
        ...
        dupFilepath = getCamDupFilepath(i)
